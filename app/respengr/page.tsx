...
export default function RespEngrPage() {
  ...
  // Little person click handler
  const handlePersonClick = () => {
    if (personState !== 'sleeping') return;
  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden pb-16">
      ...
      {/* Clickable Background Image Layer */}
      <button
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <span className="text-neutral-400">RespEngr v2.0</span>
          <span className="text-neutral-600">|</span>
