/**
 * osCatcher.js - Enhanced RespEngr Content Scanner
 * Scans /public/respengr directory and generates respengr.json
 * Features: Pre-processed HTML, image pairing, folder hierarchy
 */
...
function scanOwchieImages(articles) {
  if (!fs.existsSync(CONFIG.owchieDir)) {
    console.log('⚠️  Owchie directory not found, creating...');
    fs.mkdirSync(CONFIG.owchieDir, { recursive: true });
    return [];
  }
